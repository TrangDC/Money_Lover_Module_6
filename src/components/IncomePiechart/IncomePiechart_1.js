...
const IncomePiechart_1 = () => {
    ...
    const getTransactionIncome = (userdata, wallet_id) => {
        if (wallet_id) {
            axios.get(`http://localhost:8080/api/transactions/user/${userdata.id}/income_transaction/${selectedWalletId}/date/${currentYear}/${currentMonthIndex}`)
                .then((res) => {
                    console.log(res);
...
export default IncomePiechart_1;