        ...
        <>
            <MDBCard className='shadow-5 text-center' style={{marginTop: '-130px',marginLeft: '365px', backdropFilter: 'blur(30px)',borderRadius: '1rem', maxWidth: '650px'}}>
                <MDBCardBody className='p-5 text-center'>
                    <h2 className="fw-bold text-black mb-5 text-center" style={{marginTop: '-30px'}}>Register</h2>
                    <MDBRow>
                        <MDBCol col='10' md='6'>
                        ...
                        <MDBCol col='6' md='6'>
                            ...
                            <MDBBtn className='w-100 mb-4' size='md' color='success'>REGISTER</MDBBtn>
                            <p style={{color: 'black'}}>Have you an account? <Link to="/login" style={{color: 'green'}}>Login here</Link></p>
                        </MDBCol>
                    </MDBRow>
                </MDBCardBody>
            </MDBCard>
