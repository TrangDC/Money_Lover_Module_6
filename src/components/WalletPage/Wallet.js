                            ...
                            <MDBCard className={`card1 ${selectedWallet ? 'selected' : ''}`}>
                                <MDBCardBody className="card-body">
                                    <MDBRow className="wallet">
                                        ...
                                        <MDBCol className="content-wallet" md='8' onClick={() => handleWalletClick(wallet)}>
                                            <MDBCardText>
                                                {wallet.name}
                                            </MDBCardText>
                                            <MDBCardText>
                                ...
                                <MDBCardBody>
                                    <MDBRow style={{textAlign: 'center'}}>
                                        ...
                                        <MDBRow className="wallet-infomation">
                                            ...
                                            <MDBCol>
                                                <button className="btn-update" onClick={() => handleShow(selectedWallet.id)}> Update
                                                </button>
                                            </MDBCol>
                                            <MDBCol>
                                                {wallets.length > 1 && (
                                                    <button className="btn-delete" onClick={() => handleDelete(selectedWallet.id)}>
